...
class Gem4 extends Component {
  ...
  render() {
    return (
      <div className={`gemContainer gem4 ${!this.props.loaded ? 'gemInitial' : !this.props.landed ? 'gemMover' : ''}`} style={{ top: `${this.props.top}%`, transform: `translate(0%, ${this.props.scrollY}%)` }}>
